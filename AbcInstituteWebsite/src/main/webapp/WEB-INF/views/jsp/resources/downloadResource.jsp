...
<link href="resources/uploads/${link}"  rel="stylesheet" type="text/css" /> 
  <link href="resources/css/otherpage.css"  type="text/css" /> 
...
<div class="container">
  ...
  <div class="greeting"><form action="<c:url value='j_spring_security_logout' />" method="post"><p>Welcome,<font size="+0.75">${principleUser.name}</font>
